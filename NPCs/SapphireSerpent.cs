...
{
	internal class SapphireSerpentHead : DepthsWorm
	{
    ...
    public abstract class DepthsWorm : Worm
    {
        ...
        public override void Init()
        {
            minLength = 12;
            maxLength = 18;
            tailType = ModContent.NPCType<SapphireSerpentTail>();
            bodyType = ModContent.NPCType<SapphireSerpentBody>();
            headType = ModContent.NPCType<SapphireSerpentHead>();
            speed = 8.5f;
            turnSpeed = 0.07f;
        }
    }
